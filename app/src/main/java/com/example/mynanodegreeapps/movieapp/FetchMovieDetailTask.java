...
public class FetchMovieDetailTask  extends AsyncTask<String,Void,String>  {
    ...
    public FetchMovieDetailTask(Context context,Movie movie,boolean IsFavourite,TrailerViewAdapter trailerViewAdapter,UserReviewViewAdapter userReviewViewAdapter ,String appKey){
